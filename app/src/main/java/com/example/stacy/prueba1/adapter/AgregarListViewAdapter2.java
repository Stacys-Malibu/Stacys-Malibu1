package com.example.stacy.prueba1.adapter;
...
public class AgregarListViewAdapter2 extends BaseAdapter {

        private Context context;
        private List<Usuario> usuariosList;

        public AgregarListViewAdapter2(Context context, List<Usuario> usuariosList) {
        ...
        public View getView(int position, View vista, ViewGroup parent) {
            ...
            if (vista == null) { //No se puede reciclar
                ...
                vista = inflater.inflate(R.layout.agregar2, null);
