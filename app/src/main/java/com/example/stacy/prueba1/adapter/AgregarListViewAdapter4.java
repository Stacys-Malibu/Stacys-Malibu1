...
public class AgregarListViewAdapter4 extends BaseAdapter {

        private Context context;
        private List<Examen> examenesList;

        public AgregarListViewAdapter4(Context context, List<Examen> examenesList) {
        ...
        public View getView(int position, View vista, ViewGroup parent) {
            ...
            if (vista == null) { //No se puede reciclar
                ...
                vista = inflater.inflate(R.layout.agregar4, null);
